...
router.post('/seed-users', async (req: Request, res: Response) => {
    try {
        ...
        const users = [
            ...
            { username: 'leo', name: 'Leo', email: 'leo@lrems.local', is_admin_access: true, access_rules: [{ learning_areas: ['Science'], grade_levels: [] }] },
            { username: 'celso', name: 'Celso', email: 'celso@lrems.local', is_admin_access: true, access_rules: [{ learning_areas: ['Mathematics', 'EPP', 'TLE'], grade_levels: [] }] },
